...
> **Early development.** `v1.0.1` is the current release and the tool is in real use, but it
...
It **diagnoses only** in v1.0.1 and never writes: it prints the entries that
