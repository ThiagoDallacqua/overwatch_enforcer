...
> **Early development.** `v1.0.4` is the current release and the tool is in real use, but it
...
It **diagnoses only** in v1.0.4 and never writes: it prints the entries that
